<?php 
   include_once '../Controleur/Vol.php';
   session_start(); 
                        ...
                        <li>
                            <div class="navbar-login">
                                <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                        <p class="text-left"> <?php echo  $_SESSION['username'] ; ?> </strong> <?php echo '(', $_SESSION['user_type'] ,')'; ?> </p>
        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
					...
					<div class="col-sm-6">
						<a href="#addEmployeeModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>ajouter un vol</span></a>
			...
			<?php	include_once '../Controleur/ListVol.php'; ?>
			...
			<div class="modal-content">
				<form action="" method="POST">
					<div class="modal-header">						
						<h4 class="modal-title">ajouter un vol</h4>
                    ...
                    <div class="form-group">
							...
							<input type="text"  name="nbvol" class="form-control" required>
                        </div>				
						<div class="form-group">
							<label>Lieu Depart</label>
							<input type="text"  name="lieudepart" class="form-control" required>
                        </div>
                        <div class="form-group">
							<label>Lieu Arrive</label>
							<input type="text" name="lieuarrive" class="form-control" required>
						</div>
						<div class="form-group">
                        ...
                        <label>Nombre des places</label>
							<input type="text" name="nbplace" class="form-control" required>
						</div>	
						<div class="form-group">
                        <label>Prix(DH)</label>
					...
					<div class="modal-footer">
                        ...
                        <input type="submit" name="addvol"class="btn btn-success" value="Add">
					</div>
				</form>
			</div>
		</div>
